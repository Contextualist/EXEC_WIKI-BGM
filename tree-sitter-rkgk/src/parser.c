...
enum ts_symbol_identifiers {
  ...
  anon_sym_u4f5cu8a5eu4f5cu7de8u66f2 = 72,
  anon_sym_u4f5cu8bcdu4f5cu7f16u66f2 = 73,
  anon_sym_u4f5cu8a5eu4f5cu66f2 = 74,
  anon_sym_u4f5cu8bcdu4f5cu66f2 = 75,
  anon_sym_u4f5cu8a5eu66f2 = 76,
  anon_sym_u4f5cu8bcdu66f2 = 77,
  anon_sym_u4f5cu7de8u66f2 = 78,
  anon_sym_u4f5cu7f16u66f2 = 79,
  anon_sym_u4f5cu66f2 = 80,
  anon_sym_u7de8u66f2 = 81,
  anon_sym_u7f16u66f2 = 82,
  anon_sym_u4f5cu8a5e = 83,
  anon_sym_u4f5cu8bcd = 84,
  anon_sym_u5382u724c = 85,
  anon_sym_u811au672c = 86,
  anon_sym_u63d2u56fe = 87,
  anon_sym_u5236u4f5cu4eba = 88,
  anon_sym_u51fau7248u65b9 = 89,
  anon_sym_u5f55u97f3 = 90,
  anon_sym_u539fu4f5c = 91,
  anon_sym_u58f0u4e50 = 92,
  anon_sym_u4e50u5668 = 93,
  anon_sym_u6df7u97f3 = 94,
  anon_sym_u6bcdu5e26u5236u4f5c = 95,
  sym_parts = 96,
  sym__sep = 97,
  sym_source_file = 98,
  sym_disc = 99,
  aux_sym__disc = 100,
  sym_song = 101,
  sym_credit_block_maybeparts = 102,
  sym_credit_field_maybeparts = 103,
  sym_credit_block = 104,
  sym_credit_field = 105,
  sym__quotable_song_title_maybecomment = 106,
  sym__quotable_song_title = 107,
  sym_song_title = 108,
  sym__quotable_creator_field_maybeparts = 109,
  sym__quotable_creator_field = 110,
  sym__quotable_creator_name = 111,
  sym_creator_name = 112,
  sym_role = 113,
  sym__role = 114,
  aux_sym_source_file_repeat1 = 115,
  aux_sym_credit_block_maybeparts_repeat1 = 116,
  aux_sym_credit_field_maybeparts_repeat1 = 117,
  aux_sym_credit_field_maybeparts_repeat2 = 118,
  aux_sym_credit_block_repeat1 = 119,
  aux_sym_credit_field_repeat1 = 120,
  aux_sym_song_title_repeat1 = 121,
  aux_sym_creator_name_repeat1 = 122,
  alias_sym_creator_sep = 123,
};
...
static const TSCharacterRange aux_sym_creator_name_token1_character_set_1[] = {
  {0, 0x08}, {0x0b, 0x1f}, {'!', '%'}, {'\'', '+'}, {'-', '.'}, {'0', '9'}, {';', 0x17e}, {0x180, 0x2129},
  {0x212b, 0x2fff}, {0x3002, 0x3009}, {0x300c, 0x30fa}, {0x30fc, 0xff05}, {0xff07, 0xff0e}, {0xff10, 0xff19}, {0xff1c, 0x10ffff},
};

static const TSCharacterRange sym__role_instrument_character_set_1[] = {
  {0, 0x08}, {'\n', '%'}, {'\'', '+'}, {'-', '.'}, {'0', '9'}, {';', 0x17e}, {0x180, 0x2129}, {0x212b, 0x2fff},
  {0x3002, 0x30fa}, {0x30fc, 0xff05}, {0xff07, 0xff0e}, {0xff10, 0xff19}, {0xff1c, 0x10ffff},
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (lookahead == 0x300a) ADVANCE(332);
      if (lookahead == 0x30a2) ADVANCE(377);
      if (lookahead == 0x30a4) ADVANCE(376);
      if (lookahead == 0x30dc) ADVANCE(378);
      if (lookahead == 0x30de) ADVANCE(375);
      if (lookahead == 0x30ec) ADVANCE(379);
      if (lookahead == 0x4e50) ADVANCE(385);
      if (lookahead == 0x4f5c) ADVANCE(388);
      if (lookahead == 0x51fa) ADVANCE(393);
      if (lookahead == 0x5236) ADVANCE(381);
      if (lookahead == 0x5382) ADVANCE(394);
      if (lookahead == 0x539f) ADVANCE(382);
      if (lookahead == 0x58f0) ADVANCE(380);
      if (lookahead == 0x5f55) ADVANCE(395);
      if (lookahead == 0x63d2) ADVANCE(386);
      if (lookahead == 0x6b4c) ADVANCE(384);
      if (lookahead == 0x6bcd) ADVANCE(387);
      if (lookahead == 0x6df7) ADVANCE(396);
      if (lookahead == 0x7de8) ADVANCE(389);
      if (lookahead == 0x7f16) ADVANCE(390);
      if (lookahead == 0x811a) ADVANCE(391);
      if (lookahead == 0x827a) ADVANCE(392);
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ' ||
          lookahead == 0x3000) ADVANCE(335);
      if (lookahead != 0 &&
          lookahead != 0x17f &&
          lookahead != 0x212a) ADVANCE(334);
      END_STATE();
    case 2:
      ADVANCE_MAP(
        '\n', 310,
    ...
    case 5:
      ...
      if (set_contains(sym__sep_character_set_1, 11, lookahead)) ADVANCE(558);
      if (lookahead != 0 &&
          lookahead != 0x17f &&
          lookahead != 0x212a) ADVANCE(334);
      END_STATE();
    ...
    case 7:
      ...
      if ((0x0b <= lookahead && lookahead <= '\r')) ADVANCE(342);
      if (set_contains(sym__sep_character_set_1, 11, lookahead)) ADVANCE(558);
      if (lookahead != 0 &&
          lookahead != 0x17f &&
          lookahead != 0x212a) ADVANCE(334);
    ...
    case 15:
      if (lookahead == '\n') SKIP(15);
      if (lookahead == 0x300b) ADVANCE(333);
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ' ||
    ...
    case 16:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ' ||
          lookahead == 0x3000) ADVANCE(401);
      if (lookahead != 0 &&
          lookahead != 0x17f &&
          lookahead != 0x212a &&
          lookahead != 0x300b) ADVANCE(402);
      END_STATE();
    case 17:
      if (lookahead == '\n') ADVANCE(318);
      if (('\t' <= lookahead && lookahead <= '\r') ||
    ...
    case 25:
      ...
      if ((!eof && set_contains(aux_sym_creator_name_token1_character_set_1, 15, lookahead))) ADVANCE(403);
      END_STATE();
    case 26:
      if (lookahead == '(') ADVANCE(414);
      if (lookahead == 0x300a) ADVANCE(400);
    ...
    case 238:
      if (lookahead == 0x300a) ADVANCE(400);
      if ((0x0b <= lookahead && lookahead <= '\r')) ADVANCE(438);
      if (lookahead == '\t' ||
          lookahead == '\n' ||
          lookahead == ' ' ||
    ...
    case 239:
      ...
      END_STATE();
    case 240:
      if (lookahead == 0x30b0) ADVANCE(515);
      END_STATE();
    case 241:
      if (lookahead == 0x30b8) ADVANCE(512);
      END_STATE();
    case 242:
    ...
    case 244:
      ...
      END_STATE();
    case 245:
      if (lookahead == 0x30c8) ADVANCE(513);
      END_STATE();
    case 246:
    ...
    case 249:
      ...
      END_STATE();
    case 250:
      if (lookahead == 0x30eb) ADVANCE(514);
      END_STATE();
    case 251:
    ...
    case 255:
      ...
      END_STATE();
    case 256:
      if (lookahead == 0x4e50) ADVANCE(538);
      END_STATE();
    case 257:
    ...
    case 258:
      ...
      END_STATE();
    case 259:
      if (lookahead == 0x4f5c) ADVANCE(537);
      if (lookahead == 0x66f2) ADVANCE(287);
      END_STATE();
    case 260:
      if (lookahead == 0x4f5c) ADVANCE(541);
      END_STATE();
    case 261:
      if (lookahead == 0x5236) ADVANCE(260);
      END_STATE();
    case 262:
      if (lookahead == 0x5531) ADVANCE(517);
      END_STATE();
    case 263:
      if (lookahead == 0x5668) ADVANCE(539);
      END_STATE();
    case 264:
      if (lookahead == 0x56fe) ADVANCE(533);
      END_STATE();
    case 265:
      if (lookahead == 0x5bb6) ADVANCE(516);
      END_STATE();
    case 266:
    ...
    case 268:
      ...
      if (lookahead == 0x7de8) ADVANCE(271);
      if (lookahead == 0x7f16) ADVANCE(272);
      if (lookahead == 0x8a5e) ADVANCE(529);
      if (lookahead == 0x8bcd) ADVANCE(530);
      END_STATE();
    case 269:
      if (lookahead == 0x66f2) ADVANCE(527);
      END_STATE();
    case 270:
    ...
    case 273:
      ...
      if (lookahead == 0x7de8) ADVANCE(275);
      END_STATE();
    case 274:
      if (lookahead == 0x66f2) ADVANCE(521);
      if (lookahead == 0x7f16) ADVANCE(276);
      END_STATE();
    case 275:
    ...
    case 276:
      ...
      END_STATE();
    case 277:
      if (lookahead == 0x672c) ADVANCE(532);
      END_STATE();
    case 278:
      if (lookahead == 0x672f) ADVANCE(265);
      END_STATE();
    case 279:
      if (lookahead == 0x7248) ADVANCE(267);
      END_STATE();
    case 280:
      if (lookahead == 0x724c) ADVANCE(531);
      END_STATE();
    case 281:
      if (lookahead == 0x97f3) ADVANCE(536);
      END_STATE();
    case 282:
      if (lookahead == 0x97f3) ADVANCE(540);
      END_STATE();
    case 283:
      if (lookahead == ')' ||
          lookahead == 0xff09) ADVANCE(398);
      if ((0x0b <= lookahead && lookahead <= '\r')) ADVANCE(460);
      if (lookahead == '\t' ||
          lookahead == '\n' ||
          lookahead == ' ' ||
          lookahead == 0x3000) SKIP(283);
      if ((!eof && set_contains(aux_sym_creator_name_token1_character_set_1, 15, lookahead))) ADVANCE(403);
      END_STATE();
    case 284:
      if (lookahead == '\t' ||
      ...
      if (('\n' <= lookahead && lookahead <= '\r')) SKIP(284);
      if (set_contains(sym__sep_character_set_1, 11, lookahead)) ADVANCE(558);
      END_STATE();
    case 285:
      if (lookahead == '.' ||
          lookahead == ':' ||
          lookahead == 0xff1a) ADVANCE(397);
      END_STATE();
    case 286:
      if ((!eof && set_contains(sym__role_instrument_character_set_1, 13, lookahead))) ADVANCE(461);
      END_STATE();
    case 287:
      if (lookahead != 0 &&
          lookahead != '\n' &&
    ...
    case 310:
      ...
      if (lookahead == '\n') ADVANCE(310);
      if (lookahead == 0x300a) ADVANCE(400);
      if (lookahead == 0x4e50) ADVANCE(448);
      if (lookahead == '\t' ||
          lookahead == ' ' ||
    ...
    case 314:
      ...
      if (lookahead == 0xff08) ADVANCE(418);
      if (lookahead == '\t' ||
          lookahead == ' ' ||
    ...
    case 530:
      ...
      if (lookahead == 0x4f5c) ADVANCE(274);
